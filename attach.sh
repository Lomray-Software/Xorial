...
echo ""
echo "✓ Done. Next steps (manual mode):"
echo ""
echo "  1. Fill in .xorial/config.json:"
echo "       instance_name  — name for this machine / human (e.g. \"Misha MBP\")"
echo ""
echo "     Other fields (anthropic/openai keys, telegram, linear) drive the"
echo "     automated conductor and Slack bot — leave them as-is for manual mode."
echo ""
echo "  2. Fill in .xorial/context/project-context.md:"
echo "       Project structure, commands, E2E paths, helpers"
echo ""
echo "  3. Run a role manually — open an AI agent (Claude Code / Codex CLI /"
echo "     Cursor) inside $PROJECT_ROOT and paste:"
echo ""
echo "       Read $PROJECT_ROOT/.xorial/chat.md and follow it."
echo ""
echo "     Or take a role directly:"
echo "       Take role: $XORIAL_DIR/core/roles/05-intake.md"
echo "       Project context: $PROJECT_ROOT/.xorial/context/project-context.md"
echo "       Start your pass."
echo ""
